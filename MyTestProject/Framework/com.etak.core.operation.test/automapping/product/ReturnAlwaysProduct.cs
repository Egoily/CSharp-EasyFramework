...
{
    public class ReturnAlwaysProduct<TRequest> : AbstractBusinessOperation<RequestBaseDTO, ProductDTOBasedResponse, TRequest, ProductBasedResponse>
        where TRequest : RequestBase, new ()
    {
        ...
        protected override void MapNotAutomappedOutboundProperties(ProductBasedResponse coreOutput, ref ProductDTOBasedResponse dtoOutput)
        {
        }

        protected override ProductBasedResponse ProcessBusinessLogic(TRequest request, model.operation.BusinessOperationExecution runningOperation, RequestInvokationEnvironment invoker)
        {
            ...
            return new ProductBasedResponse()
            {
                Product = proInfo,
                ErrorCode = 0,
