...
{
    [TestFixture]
    public class GetHolidayInfoByIdMSTest : AbstractMicroServiceTest<GetHolidayInfoByIdMS, GetHolidayInfoByIdRequest, GetHolidayInfoByIdResponse>
    {
        ...
        [TestCase(20150101)]
        public void GetHolidayInfoByIdMSOk(int testParameter)
        {
        ...
        [TestCase(20150102)]
        public void GetHolidayInfoByIdMSNOk(int testParameter)
        {
