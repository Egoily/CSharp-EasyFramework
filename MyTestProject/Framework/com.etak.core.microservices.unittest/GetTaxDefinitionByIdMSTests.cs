...
{
    [TestFixture()]
    public class GetTaxDefinitionByIdMSTests : AbstractMicroServiceTest<GetTaxDefinitionByIdMS, GetTaxDefinitionByIdRequest, GetTaxDefinitionByIdResponse>
    {
        ...
        [TestCase(100)]
        public void GetTaxDefinitionByIdMSTestsOk(int testParameter)
        {
        ...
        [TestCase(200)]
        public void GetTaxDefinitionByIdMSTestsNOk(int testParameter)
        {
        ...
        [TestCase(300)]
        public void GetTaxDefinitionByIdMSTestsNOkNull(int testParameter)
        {
            var request = new GetTaxDefinitionByIdRequest()
            {
                TaxDefinitionId = testParameter,
