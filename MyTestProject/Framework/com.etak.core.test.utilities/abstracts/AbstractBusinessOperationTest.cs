        ...
        public void MockAbsctractBusinessOperation(RequestBaseDTO requestDto)
        {
            ...
            if (jointCustomer != null)
            {
                ...
                if (jointCustIdDtoRequest != null)
                {
                    ...
                    actualSourceCustomer.CustomerID = jointCustIdDtoRequest.DestinationCustomerId;
                    mockedRepoCustomerInfo.GetById(jointCustIdDtoRequest.DestinationCustomerId).Returns(actualSourceCustomer);
                }
                else
                {
