...
{
    public class ReturnAlwaysProduct : AbstractBusinessOperation<RequestBaseDTO, ProductOfferingDTOBasedResponse, DummyRequest, ProductOfferingBasedResponse>
    {
        ...
        protected override void MapNotAutomappedOutboundProperties(ProductOfferingBasedResponse coreOutput, ref ProductOfferingDTOBasedResponse dtoOutput)
        {
        }

        protected override ProductOfferingBasedResponse ProcessBusinessLogic(DummyRequest request, model.operation.BusinessOperationExecution runningOperation, RequestInvokationEnvironment invoker)
        {
            ...
            return new ProductOfferingBasedResponse()
            {
                ProductOffering = proInfo,
                ErrorCode = 0,
