...
namespace com.etak.core.operation.UnitTests.dtoConverter
{
    ...
    {
        [Test()]
        public static void ToDto_CorrectProductChargeOptionWithChargeRecurring_ShouldReturnProductPurchaseChargingOptionDTO()
        {
        ...
        [Test()]
        public static void ToDto_CorrectProductChargeOptionWithChargeRecurringWithEndDateNull_ShouldReturnProductPurchaseChargingOptionDTO()
        {
            #region Set all the properties
            var proInfo = new ProductChargeOption()
            {
                CreateDate = CreateDefaultObject.Create<DateTime>(),
                //EndDate = CreateDefaultObject.Create<DateTime>(), NULL FIELD
                Id = CreateDefaultObject.Create<int>(),
                IsDefaultOption = DefaultOptions.Y,
                ProductOffering = CreateDefaultObject.Create<ProductOffering>(),
                StartDate = CreateDefaultObject.Create<DateTime>(),
        ...
        private static void CheckAreEquals(ProductChargeOption proInfo, ProductPurchaseChargingOptionDTO proDto)
        {
            ...
            Assert.AreEqual(proDto.ExpirationDate, proInfo.EndDate);
