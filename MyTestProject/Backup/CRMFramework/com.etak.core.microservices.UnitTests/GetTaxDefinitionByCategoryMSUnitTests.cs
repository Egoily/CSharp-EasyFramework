...
namespace com.etak.core.microservices.UniTests
{
    ...
    public class GetTaxDefinitionByCategoryMSUnitTests : AbstractMicroServiceTest<GetTaxDefinitonsByCategoryMS, GetTaxDefinitonsByCategoryRequest, GetTaxDefinitonsByCategoryResponse>
    {
        ...
        [TestCase(100)]
        public void Process_CorrectTaxCategory_ShouldReturnTaxDefinitions(int testParameter)
        {
        ...
        [TestCase(300)]
        public void Process_TaxCategoryHasNoTaxDefinitions_ShouldReturnEmptyTaxDefinitions(int testParameter)
        {
            var request = new GetTaxDefinitonsByCategoryRequest()
            {
                TaxCategory = testParameter,
