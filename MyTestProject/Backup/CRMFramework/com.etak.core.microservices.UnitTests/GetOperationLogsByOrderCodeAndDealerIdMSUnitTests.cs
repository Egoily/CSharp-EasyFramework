...
namespace com.etak.core.microservices.UniTests
{
    ...
    [TestFixture]
    public class GetOperationLogsByOrderCodeAndDealerIdMSUnitTest :
                ...
                GetOperationLogsByOrderCodeAndDealerIdResponse>
    {
        ...
        [TestCase(100)]
        public void Process_CorrectOrderCodeAndDealerId_ShouldReturnOperationLogs(int testParameter)
        {
        ...
        [TestCase(300)]
        public void Process_OrderCodeAndDealerIdHasNoOperationLogs_ShouldReturnEmptyOperationLogs(int testParameter)
        {
            var request = new GetOperationLogsByOrderCodeAndDealerIdRequest()
            {
                OrderCode = testParameter,
