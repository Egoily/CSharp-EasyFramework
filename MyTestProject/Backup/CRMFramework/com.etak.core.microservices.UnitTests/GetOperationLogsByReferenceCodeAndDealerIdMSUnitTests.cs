...
namespace com.etak.core.microservices.UniTests
{
                ...
                GetOperationLogsByReferenceCodeAndDealerIdResponse>
    {
        ...
        [TestCase(100)]
        public void Process_CorrectReferenceCodeAndDealerId_ShouldReturnOperationLogs(int testParameter)
        {
        ...
        [TestCase(300)]
        public void Process_ReferenceCodeAndDealerIdHasNoOperationLogs_ShouldReturnEmptyOperationLogs(int testParameter)
        {
            var request = new GetOperationLogsByReferenceCodeAndDealerIdRequest()
            {
                ReferenceCode = testParameter.ToString(),
