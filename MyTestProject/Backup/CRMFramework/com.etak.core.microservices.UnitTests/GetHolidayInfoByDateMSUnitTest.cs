...
{
    [TestFixture]
    public class GetHolidayInfoByDateMSUnitTest : AbstractMicroServiceTest<GetHolidayInfoByDateMS, GetHolidayInfoByDateRequest, GetHolidayInfoByDateResponse>
    {
        ...
        [TestCase(1)]
        public void Process_CorrectDate_ShouldReturnCorrectHolidayInfo(int testParameter)
        {
        ...
        [TestCase(3)]
        public void Process_DateHasNoHolidayInfo_ShouldReturnEmptyHolidayInfo(int testParameter)
        {
            var request = new GetHolidayInfoByDateRequest()
            {
                Date = new DateTime(2015, 01, testParameter),
