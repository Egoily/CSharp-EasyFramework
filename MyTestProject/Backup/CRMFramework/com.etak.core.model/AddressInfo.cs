...
namespace com.etak.core.model
{
    ...
    public class AddressInfo
    {
        public AddressInfo()
        {
            AddressUsages = new List<CustomerAddress>();
        }
        ...
        public virtual IList<CustomerAddress> AddressUsages { get; set; }
     

        public virtual bool CompareInformation(AddressInfo compareObj)
        {
            if (
                (string.IsNullOrEmpty(this.Address) ? "" : this.Address) == (string.IsNullOrEmpty(compareObj.Address) ? "" : compareObj.Address)
                ...
                && (string.IsNullOrEmpty(this.BuildingDoor) ? "" : this.BuildingDoor) == (string.IsNullOrEmpty(compareObj.BuildingDoor) ? "" : compareObj.BuildingDoor)
                ...
                && (string.IsNullOrEmpty(this.HouseExtention) ? "" : this.HouseExtention) == (string.IsNullOrEmpty(compareObj.HouseExtention) ? "" : compareObj.HouseExtention)
