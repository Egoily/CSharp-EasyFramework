...
namespace com.etak.core.model
{
   ...
   /// </summary>
    [DataContract]
    [Serializable]
    public class MNPOriginalNrnRangeInfo
   {
      #region 构造函数
      public MNPOriginalNrnRangeInfo()
      {}

      public MNPOriginalNrnRangeInfo(string RANGE1, string RANGE2, string OPERATORCODE, string OPERATORNAME, DateTime STARTDATE, DateTime ENDDATE, DateTime CREATEDATE)
      {
         this._RANGE1=RANGE1;
         this._RANGE2=RANGE2;
