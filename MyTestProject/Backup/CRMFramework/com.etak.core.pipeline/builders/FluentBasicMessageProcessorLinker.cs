...
namespace com.etak.core.pipeline.builders
{
    ...
    {     
        ...
        private bool _useSessionAuthoritzation = false;
        ...
        /// </summary>
        /// <returns></returns>
        public FluentBasicMessageProcessorLinker<TExtInput, TExtOutput, TCoreInput, TCoreOutput> UseSessionAuthoritzation()
        {
            _useSessionAuthoritzation = true;
            return this;
        }
        ...
        public void Build()
        {
            ...
            if (_useSessionAuthoritzation)
            {
                PipeLineManager.RegisterFrontEndOperation<TExtInput, TExtOutput>().To<SessionAuthBasedProcessor<TExtInput, TExtOutput, TCoreInput, TCoreOutput>>(); 
            }
            else
            {
