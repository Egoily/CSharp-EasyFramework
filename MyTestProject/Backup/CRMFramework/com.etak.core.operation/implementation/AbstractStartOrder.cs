...
namespace com.etak.core.operation.implementation
{
    ...
    public abstract class AbstractStartOrder<TDTOInput, TDTOOutput, TInternalInput, TInternalOutput, TOrder, TProcessor> : AbstractBusinessOperation<TDTOInput, TDTOOutput, TInternalInput, TInternalOutput>
        ...
        where TProcessor : IOrderProcessor<TOrder, TInternalInput, TInternalOutput>, new()
    {
        ...
        protected override TInternalOutput ProcessBusinessLogic(TInternalInput request, BusinessOperationExecution runningOperation, RequestInvokationEnvironment invoker)
        {
            ...
            return CreateOrderHelper.GenerateOrderAndProcess<TInternalInput, TInternalOutput, TOrder>(request, runningOperation, processor.ProcessRequest, persistOrder);
        }
