...
namespace com.etak.core.repository.NHibernate.IDGeneration
{
    ...
    /// </summary>
    public class SessionIdGenerator : IIdentifierGenerator, IConfigurable
    {
        ...
        /// <summary>
        /// Implementaion of IIdentifierGenerator, generates a new ID everytime we attempt to save an object
        /// </summary>
        ...
        public object Generate(global::NHibernate.Engine.ISessionImplementor session, object obj)
        {
            ...
            Int64 id = (unixTimestamp << 32) | (_middleFix << 16) | (Interlocked.Increment(ref _counter) & 0x0000FFFF) ;
        ...
        /// <param name="parms">the set of parameters configured in the Id generation in the Nhibernate mapping</param>
