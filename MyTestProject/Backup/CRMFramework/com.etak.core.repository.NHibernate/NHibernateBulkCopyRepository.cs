...
{
    /// <summary>
    /// Repository that extends NHibernate repository, and implements BulkRepository.
    /// It reads the configuration of the schema from NHibernate but implements the operation
    /// with BulkCopy API SQL server operation, this repository only works with MS SQL Server
    /// </summary>
        ...
        IBulkRepository<TEntity, TKey> where TEntity : class , new()
    {
        ...
        /// <param name="path">an array of lambda expression to get the fields that needs to be updated</param>
        ...
        /// <param name="paths">the columns that needs to be added to the data table as lambda expressions</param>
